    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            for(int i=0;i<fri.length();i++){
                String morning9 = fri.getString("9:00-10:00");
                String morning10 = fri.getString("10:00-11:00");
                String morning12 = fri.getString("11:15-12:15");
                String morning2 = fri.getString("12:15-1:15");
                String morning = fri.getString("3:00-6:00");
