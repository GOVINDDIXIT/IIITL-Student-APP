    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            for(int i=0;i<tue.length();i++){
                String morning9 = tue.getString("9:00-10:00");
                String morning10 = tue.getString("10:00-11:00");
                String morning12 = tue.getString("11:15-12:15");
                String morning2 = tue.getString("12:15-1:15");
                String morning = tue.getString("3:00-6:00");
